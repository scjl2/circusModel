...
public class TakeOffHandler extends PeriodicEventHandler
{
	/**
	 * Controlling mission
	 */
	 ...
	 * @param takeoffMission controlling mission
	 */
	public TakeOffHandler(PriorityParameters priority, PeriodicParameters periodic,
			StorageParameters storage,  TakeOffMission takeoffMission, double takeOffAltitude, 
